...
function nextQuestion() {
    ...
    saveProgress(currentQuestion, answersArray);
...
function prevQuestion() {
    if (currentQuestion > 0) {
        currentQuestion--;
        selectedAnswer = answersArray[currentQuestion] || null;
        displayQuestion();
    }
}
...
// คำนวณ character ที่ตรงกับคะแนน
